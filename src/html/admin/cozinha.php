...
if (!isset($_SESSION['user']) and !isset($_SESSION['tipo_session']) and !isset($_SESSION['userId'])) {
    ...
    exit;
} elseif ($_SESSION['userId'] != "Cozinha" and $_SESSION['userId'] != "Gerencia") {
    session_destroy();
    header("location: index.php");
    exit;
}
...
<body>
    ...
    <nav class="topo navbar navbar-expand navbar-dark sticky-top">
        ...
        <a href="../../scripts/php/func_sair.php"><button class="btn btn-outline-light btn-md" type="submit">Sair</button></a>
    </nav>

    <form method="POST" class="tabela container" action="../../scripts/php/func_cozinha.php">
            ...
            <tbody>
                <tr>
                    <?php do { ?>
                        ...
                        <td>
                            <button value="Pronto" role="button" class="btn btn-outline-warning btn-lg text-center" name="enviar">Pronto</button>
                        </td>
                </tr>
