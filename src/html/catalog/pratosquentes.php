    ...
    <div class="container box">
        <div class="row centro d-flex justify-content-center d-flex flex-wrap">
            <div class="card card-deck m-auto " style="width: 12rem; height: 24rem;">
                <img class="card-img-top" src="../../img/teppan.png" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Teppan</h6>
                    <h6 class="card-title">R$45,00</h6>
                    <input type="hidden" name="nome" value="Teppan">
                    <input type="hidden" name="valor" value="45">
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Pedaços de salmão grelhado servidos com legumes.">
                        ?
                    </button>
                    <button class="btn btn-dark btn-sm" type="submit" name="adicionarPQ">Adicionar</button>
                </form>
            </div>

            <div class="card card-deck m-auto " style="width: 12rem; height: 24rem;">
                <img class="card-img-top" src="../../img/yakisoba.png" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Yakisoba</h6>
                    <h6 class="card-title">R$43,00</h6>
                    <input type="hidden" name="nome" value="Yakisoba">
                    <input type="hidden" name="valor" value="43">
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Macarrão com legumes, verduras agregado com carne 
						bovina, frango, camarão, misto ou vegetariano.">
                        ?
                    </button>
                    <button class="btn btn-dark btn-sm" type="submit" name="adicionarPQ2">Adicionar</button>
                </form>
            </div>

            <div class="card card-deck m-auto" style="width: 12rem; height: 24rem;">
                <img class="card-img-top" src="../../img/tempuracamarao.png" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Tempurá</h6>
                    <h6 class="card-title">R$37,00</h6>
                    <input type="hidden" name="nome" value="Tempurá">
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vegetais ou camarões envoltos com uma massa fina e fritos .">
                        ?
                    </button>
                    <button class="btn btn-dark btn-sm" type="submit" name="adicionarPQ3">Adicionar</button>
                </form>
            </div>

            <div class="card card-deck m-auto " style="width: 12rem; height: 24rem;">
                <img class="card-img-top" src="../../img/missoshiro.jpg" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Missoshiru</h6>
                    <h6 class="card-title">R$12,00</h6>
                    <input type="hidden" name="nome" value="Missoshiru">
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Sopa preparada com soja, hondashi, tofu e cebolinha.">
                        ?
                    </button>
                    <button class="btn btn-dark btn-sm" type="submit" name="adicionarPQ4">Adicionar</button>
                </form>
            </div>
                ...
                <div class="modal-content">
                    <form id="ajax_form" action="../../scripts/php/func_pedidos.php" method="POST">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <button class="btn btn-outline-warning btn-md text-center" name="cancelarPQ" type="submit" data-backdrop="static">Cancelar Pedido</button>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="enviarPQ" class="btn btn-secondary">Enviar para Preparo</button>
