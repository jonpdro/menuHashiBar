    ...
    <div class="container box">
        <div class="row centro d-flex justify-content-center d-flex flex-wrap">
            ...
            <div class="card card-deck m-auto " style="width: 12rem; height: 22rem;">
                <img class="card-img-top" src="../../img/sashimisalmao.jpg" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Salmão (12UN)</h6>
                    <h6 class="card-title">R$30,00</h6>
                    <input type="hidden" name="nome" value="Sashimi Salmão (12UN)">
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Fatias de salmão cru.">
                        ?
                    </button>
                    <button name="adicionarSA" class="btn btn-dark btn-sm">Adicionar</button>
                </form>
            </div>

            <div class="card card-deck m-auto " style="width: 12rem; height: 22rem;">
                <img class="card-img-top" src="../../img/sashimipeixebranco.jpg" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Peixe Branco (12UN)</h6>
                    <h6 class="card-title">R$28,00</h6>
                    <input type="hidden" name="nome" value="Sashimi Peixe Branco (12UN)">
                    <input type="hidden" name="valor" value="28">
                    <select class="form-control form-control-sm" name="qntd">
                        <option selected>Quantidade</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Fatias de peixe branco cru.">
                        ?
                    </button>
                    <button name="adicionarSA2" class="btn btn-dark btn-sm">Adicionar</button>
                </form>
            </div>

            <div class="card card-deck m-auto " style="width: 12rem; height: 22rem;">
                <img class="card-img-top" src="../../img/sashimipolvo.jpg" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Polvo (12UN)</h6>
                    <h6 class="card-title">R$34,00</h6>
                    <input type="hidden" name="nome" value="Sashimi Polvo (12UN)">
                    <input type="hidden" name="valor" value="34">
                    <select class="form-control form-control-sm" name="qntd">
                        <option selected>Quantidade</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Fatias de polvo.">
                        ?
                    </button>
                    <button name="adicionarSA3" class="btn btn-dark btn-sm">Adicionar</button>
                </form>
            </div>

            <div class="card card-deck m-auto " style="width: 12rem; height: 22rem;">
                <img class="card-img-top" src="../../img/sashimimisto.png" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Misto (12UN)</h6>
                    <h6 class="card-title">R$40,00</h6>
                    <input type="hidden" name="nome" value="Misto (12UN)">
                    <input type="hidden" name="valor" value="40">
                    <select class="form-control form-control-sm" name="qntd">
                        <option selected>Quantidade</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Fatias de peixe branco, salmão e polvo.">
                        ?
                    </button>
                    <button name="adicionarSA4" class="btn btn-dark btn-sm">Adicionar</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form id="ajax_form" action="../../scripts/php/func_pedidos.php" method="POST">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <button class="btn btn-outline-warning btn-md text-center" name="cancelarSA" type="submit" data-backdrop="static">Cancelar Pedido</button>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="enviarSA" class="btn btn-secondary">Enviar para Preparo</button>
