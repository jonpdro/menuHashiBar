...
<body background="../../img/background.jpg">
    ...
    <div class="container box">
        <div class="row centro d-flex justify-content-center d-flex flex-wrap">
            ...
            <div class="card card-deck m-auto " style="width: 12rem; height: 28rem;">
                <img class="card-img-top" src="../../img/temakiebihotsalmao.png" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Especial</h6>
                    <h6 class="card-title">R$28,00</h6>
                    <input type="hidden" name="nome" value="Temaki">
                    <input type="hidden" name="valor" value="28">
                    <select class="form-control form-control-sm" name="sabor">
                        <option selected>Sabor</option>
                        <option value="Ebi Hot Salmão">Ebi Hot Salmão</option>
                        <option value="Ebi Hot Camarão">Ebi Hot Camarão</option>
                        <option value="Salmão com Shimeji">Salmão com Shimeji</option>
                    </select>
                    <br>
                    ...
                    <br>
                    <input type="checkbox" class="form-check-input" id="exampleCheck1" name="base" value="Sem Arroz">
                    <label class="form-check-label" for="exampleCheck1">Sem Arroz</label>
                    <br><br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Enrolado em formato de cone, é composto pelo 
						nori na parte externa, arroz e salmão empanado, camarão empanado ou salmão com shimeji como recheios.">
                        ?
                    </button>
                    <button name="adicionarT" class="btn btn-dark btn-sm">Adicionar</button>
                </form>
            </div>

            <div class="card card-deck m-auto " style="width: 12rem; height: 28rem;">
                <img class="card-img-top" src="../../img/temaki.png" alt="Card image cap">
                <form class="card-body text-center" method="POST" action="../../scripts/php/func_adicionar.php">
                    <h6 class="card-title">Comuns</h6>
                    <h6 class="card-title">R$24,00</h6>
                    <input type="hidden" name="nome" value="Temaki">
                    <input type="hidden" name="valor" value="24">
                    <select class="form-control form-control-sm" name="sabor">
                        <option selected>Sabor</option>
                        <option value="Salmão">Salmão</option>
                        <option value="Salmão Filadélfia">Salmão Filadélfia</option>
                    ...
                    <br>
                    <input type="checkbox" class="form-check-input" id="exampleCheck2" name="base" value="Sem Arroz">
                    <label class="form-check-label" for="exampleCheck2">Sem Arroz</label>
                    <br><br>
                    <button type="button" class="btn btn-dark btn-sm" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Enrolado em formato de cone, é composto pelo 
						nori na parte externa, arroz e kani, peixe branco, polvo, camarão, salmão, salmão
						filadelfia (com cream cheese) ou pele de peixe frita (skin) como recheios.">
                        ?
                    </button>
                    <button name="adicionarT2" class="btn btn-dark btn-sm">Adicionar</button>
                </form>
            </div>
            ...
            <div class="modal-content">
                <form id="ajax_form" action="../../scripts/php/func_pedidos.php" method="POST">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <button class="btn btn-outline-warning btn-md text-center" name="cancelarT" type="submit" data-backdrop="static">Cancelar Pedido</button>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="enviarT" class="btn btn-secondary">Enviar para Preparo</button>
